...
public class VdRplVO {
	...
	public void setRplRgstTm(String rplRgstTm) {
		this.rplRgstTm = rplRgstTm;
	}

	public String getRplRgstTm() {
		return this.rplRgstTm;
	}
